...
export default function Home() {
  ...
  const [banner_picm, setBannerPic] = useState([
      {
          url:
              'https://static-dev.roncoo.com/course/BewWesgqDLm6xO5QFlWMSfMFxKKb1LuV.jpg',
          title: '小程序体验环境',
      },
      {
          url:
              'https://static-dev.roncoo.com/course/f7qzDxnJhPdJvnDygDfITyIieoyMDsnu.jpg',
          title: '极课教育系统',
      },
  ]);
